...
class TestMeanVarRiskMeasureSAA(unittest.TestCase):
    ...
    def testCostValue(self):
        ...
        risk = TransformedMeanRiskMeasureSAA(model, prior, comm_sampler=self.comm_sampler)
    ...
    def _setup_transformed_mean_risk_measure(self, model, prior, sample_size, beta):
    ...
    def testSavedSolution(self):
        ...
        risk = self._setup_transformed_mean_risk_measure(model, prior, SAMPLE_SIZE, BETA)
