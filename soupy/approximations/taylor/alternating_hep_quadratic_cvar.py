...
class _TaylorAlternatingHEPQuadraticCVaRLegacy:
    """Gaussian-mixture quadratic Taylor CVaR with fixed HEP direction per instance."""
...
class TaylorAlternatingHEPQuadraticCVaRControlCostFunctional(ControlCostFunctional):
    """Gaussian mixture with quadratic Taylor CVaR approximation and fixed HEP direction."""
    ...
    def __init__(
        ...
        self._legacy = _TaylorAlternatingHEPQuadraticCVaRLegacy(
            self.settings,
            control_model,
            prior,
            penalization,
...
__all__ = ["TaylorAlternatingHEPQuadraticCVaRControlCostFunctional"]
