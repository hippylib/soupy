...
def print_driver_banner(args, log_path):
    ...
    print("  saa_1 / saa_10 / saa_20 / saa_50 / saa_100 / saa_200 / saa_500")
...
def make_cvar_cost(model_name, control_model, prior, penalty, args, epsilon_override=None):
    if is_saa_model(model_name):
        ...
        return make_cvar_saa_cost(control_model, prior, penalty, args.cvar_beta, sample_size, args.saa_seed, MPI.COMM_WORLD if sample_size >= 11 else MPI.COMM_SELF, epsilon=1e-4 if epsilon_override is None else float(epsilon_override))
