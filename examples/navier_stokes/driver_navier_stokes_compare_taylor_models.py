...
def main():
    ...
    parser.add_argument("--stabilization", action="store_true", help="Use GLS stabilization")
    parser.add_argument("--no-stabilization", dest="stabilization", action="store_false")
    parser.add_argument("--nitche", action="store_true", help="Use Nitsche boundary terms")
